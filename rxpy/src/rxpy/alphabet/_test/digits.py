...
class CharSetTest(TestCase):
    ...
    def test_contains(self):
        assert '0' not in CharSet([('1', '1')])
        assert '1' in CharSet([('1', '1')])
        assert '2' not in CharSet([('1', '1')])
        assert '0' in CharSet([('0', '1')])
        assert '1' in CharSet([('0', '1')])
        assert '2' not in CharSet([('0', '1')])
        assert '0' in CharSet([('0', '2')])
        assert '1' in CharSet([('0', '2')])
        assert '2' in CharSet([('0', '2')])
        assert '0' in CharSet([('0', '1'), ('1', '2')])
        assert '1' in CharSet([('0', '1'), ('1', '2')])
        assert '2' in CharSet([('0', '1'), ('1', '2')])
        assert '0' in CharSet([('0', '0'), ('2', '2')])
        assert '1' not in CharSet([('0', '0'), ('2', '2')])
        assert '2' in CharSet([('0', '0'), ('2', '2')])
